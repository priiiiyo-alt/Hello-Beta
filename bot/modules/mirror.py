...
from bot import bot, dispatcher, Interval, OWNER_ID, INDEX_URL, BUTTON_FOUR_NAME, BUTTON_FOUR_URL, BUTTON_FIVE_NAME, BUTTON_FIVE_URL, BUTTON_SIX_NAME, BUTTON_SIX_URL, FSUB, \
                MEGA_API_KEY, VIEW_LINK, aria2, QB_SEED, DOWNLOAD_DIR, download_dict, download_dict_lock, TG_SPLIT_SIZE, LOGGER, MIRROR_LOGS, BOT_PM, MEGAREST, DB_URI, \
                CHANNEL_USERNAME, LEECH_ENABLED, LEECH_LOG, LEECH_LOG_ALT, LINK_LOGS, INCOMPLETE_TASK_NOTIFIER, SOURCE_LINK, FSUB_CHANNEL_ID, AUTO_DELETE_UPLOAD_MESSAGE_DURATION
